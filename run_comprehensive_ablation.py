...
def main():
    ...
    try:
        ...
        readme.append("                                     |")
        readme.append("                                     v")
        readme.append("                  WavLM-Base-Plus Encoder (Frozen middle layers)")
        readme.append("                                     |")
        readme.append("                                     v")
        ...
        readme.append("  +-----------------------------+                         +-----------------------------+")
        readme.append("  | Mean Segment Pooling        |                         |  Group Segments by Speaker  |")
        readme.append("  +-----------------------------+                         +-----------------------------+")
        readme.append("         |                                                               |")
        readme.append("         +--------------------------+                                    v")
        readme.append("         |                          |                             +-----------------------------+")
        ...
        readme.append("  +------------------+              |                                    |")
        readme.append("  | Projection (256) |              |                                    v")
        readme.append("  +------------------+              |                             +-----------------------------+")
        ...
        readme.append("To segment the audio datasets into 10-second sliding windows and create the MIX dataset metadata:")
        readme.append("```bash")
